package net.greenjab.jabsfixedmobsandblocks.client.mixin.particle;
...
public abstract class ElderGuardianParticleMixin {
    ...
    private GuardianParticleModel phantom(GuardianParticleModel original,
        ...
        if (y<-500) return new GuardianParticleModel(Minecraft.getInstance().getEntityModels().bakeLayer(ModelLayers.PHANTOM));
        return original;
    }
}
